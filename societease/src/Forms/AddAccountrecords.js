...
function AddAccountrecords() {
  ...
  return (
    ...
    >
      ...
      Hi {sessionStorage.getItem("name")}!  Add Expenses
    </h1>
        ...
        <form
          onSubmit={handleSubmit((data) => {
            let formData = {
              ...
              commite_member_id: parseInt(sessionStorage.getItem("member_id")),
              //validated by:?
            };
        ...
        >
          ...
          <div class="max-w-sm mx-auto">
            ...
            <input
              ...
              placeholder="Salary for watchman "
          ...
          <div class="relative z-0 w-full mb-4 group">
            ...
            htmlFor="payment_method">Method of Payment:</label>
            <select
...
export default AddAccountrecords;
