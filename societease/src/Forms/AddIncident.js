...
function AddIncident() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-cover bg-center" style={{ backgroundImage: `url('your-background-image-url')` }}>
      ...
      Hi {sessionStorage.getItem("name")}!  Add Incident
    </h1>
        <form
          onSubmit={handleSubmit((data) => {
            let formData = {
              ...data,
              member_id: parseInt(sessionStorage.getItem("member_id")),
              //validated by:?
            };
          ...
          className="space-y-6"
        >
          <h2 className="text-3xl font-bold text-center mb-8">Issue Report </h2>
          ...
          <div class="max-w-sm mx-auto">
            ...
            htmlFor="description">Description of the Issue</label>
            <textarea
            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="lack of available parking spaces " {...register("description")} 
            />
          </div>
